...
trait Helper
{
    ...
    private function medianaSendBulkSMS(string $message, array $mobiles, $smsNumber, bool $filterBlackList = true, $users = null)
    {
    ...
    public function timeFilterQuery($list, $sinceDate = null, $tillDate = null, $by = 'created_at', $timeZoneConvert = true)
    {
        if ($sinceDate){
    ...
    protected function machineReadableResponse($mobiles, string $message, array|string $operator, $response, bool $has_response, bool $has_error , bool $has_result = true): array
    {
