...
//            'is_favored'     => $this->is_favored ,
            ...
            // ToDo : is_favored has been commented because Android has a problem which was related to this field.
            // ToDo : In the project of landing page of Abrisham Pro this field was essential in the response data.
            // ToDo : So I added a new key which is is_favored_2 . In this way this field is available in response and it has no effect on Android application
