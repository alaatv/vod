    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'backgroundColor' => array_key_exists($product?->id,
                \App\Product::ABRISHAM_2_DATA) ? \App\Product::ABRISHAM_2_DATA[$product?->id]['color'] : null,
            ...
            'product' => [
                ...
                'lesson_name' => array_key_exists($product?->id,
                    \App\Product::ABRISHAM_2_DATA) ? \App\Product::ABRISHAM_2_DATA[$product?->id]['lesson_name'] : null,
            ],
